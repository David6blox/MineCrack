package net.mcreator.minecrack;
...
@Mod("minecrack")
public class MinecrackMod {
	public static final Logger LOGGER = LogManager.getLogger(MinecrackMod.class);
	public static final String MODID = "minecrack";
